...
/**
 * Adaptador real para la IA Afectiva utilizando la API oficial de Groq (Modelo llama-3.1-8b-instant).
 * Implementa los principios de Calm Technology y control estricto de consumo de tokens (Free Tier).
 */
...
- Observación del Docente: ${opciones.descripcionProfesor}`
      ...
      console.error(`⚠️ Error al llamar a la API de Groq (${this.modelName}):`, error.message);
      return this.generarPausaFallback(opciones);
    }
  }
